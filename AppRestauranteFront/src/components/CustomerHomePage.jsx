...
const CustomerHomePage = () => {
  ...
  return (
    <div className="font-sans bg-white min-h-screen">
      <div className="bg-[#f8f1e9] py-20 text-center" id="inicio-section">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-[#81412f] mb-4">¡BIENVENIDO DE VUELTA!</h1>
          <p className="text-xl text-[#5a3927]">Disfruta de nuestros servicios</p>
        </div>
      </div>

      <div className="container mx-auto py-8 px-4" id="promociones-section">
        <h2 className="text-2xl font-bold text-[#81412f] mb-6">Tus Promociones</h2>
